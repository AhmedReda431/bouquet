        ...
        <div class="img-slider">
            <div class="slides">
                <div class="slider-img">
                    <img loading="lazy" :src="blog_image" alt="cover image">
                    <nuxt-link :to="localePath('/store/5')" class="slider-link"></nuxt-link>
                </div>
            </div>
        </div>
    ...
    data() {
        return {
            slides: [
                {
                    id:1,
                    img:require('@/assets/images/slider/slider1.png'),
                    title: "slider1"
                },
                {
                    id:2,
