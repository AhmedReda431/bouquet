        ...
        <div class="row">
          <div class="col-lg-8 col-md-9 col-7">
            <div class="top-left">
              <ul class="list-style cflex">
                <li class="list">
                  <nuxt-link
                    :to="localePath('/auth/supplier/supplierLogin')"
                    class="list-link"
                  >
                    <span>
                      <svg
                    ...
                    {{$t('Continue As Supplier')}}
                  </nuxt-link>
                </li>
                <li class="list">
                  <a href="tel:{0553009319}" class="list-link">
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="12"
                ...
                <li class="list">
                  <a href="mailto:{info@Wothoq.co}" class="list-link">
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="12"
          ...
          <div class="col-lg-4 col-md-3 col-5">
            <div class="top-right">
              <ul class="list-style cflex">
                <li class="list">
                  <a href="https://instagram.com" class="list-link">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
                      height="14"
                ...
                <li class="list">
                  <a href="https://facebook.com" class="list-link">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
                      height="14"
                ...
                <li class="list">
                  <a href="https://twitter.com/Wothog" class="list-link">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="14"
                      height="14"
        ...
        <div class="row">
            ...
            <div class="search-nav">
              <form @submit.prevent="navSearch" class="search-form">
                <input
                  ...
                  class="input-search"
                />
                <button type="submit" class="button-search" @click="navSearch">
                  <span class="desktop-search">
                    {{ $t("search") }}
                    <img
                      src="~/assets/images/icons/arrow_right_long.svg"
                      alt="arrow_right_long"
                    />
                  </span>
          ...
          <div class="col-lg-4 col-md-4 col-12 middle-actions-nav">
            <div class="actions-nav cflex">
              <nuxt-link :to="localePath('/cart')" class="actions-link">
                <span class="cart-count">{{ cartItemsLength }}</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
              ...
              <template v-if="isUser">
                <nuxt-link
                  :to="localePath('/supplier/statistics')"
                  class="actions-link"
                ...
                <nuxt-link
                  :to="localePath('/profile/general-info')"
                  class="actions-link"
              ...
              <!-- <nuxt-link
                ...
                v-if="userData"
              >
                <button class="btn p-0 m-0" @click="signOut">
                  {{ $t("sign_out") }}
                </button>
              </nuxt-link> -->
              ...
              <nuxt-link
                :to="localePath('/supplier/general-info')"
                class="actions-link"
                v-if="userData && logedType === 'supplier'"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
              ...
              <!--<nuxt-link :to="localePath('/quote')" class="actions-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: #1F222B;"><path d="M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10 10-4.486 10-10S17.514 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"></path></svg>
                {{$t("quote")}}
              </nuxt-link>-->
            </div>
          </div>
            ...
            <ul class="list-style cflex">
              ...
              >
                ...
                >
                  ...
                  <nuxt-link
                    :to="
                      localePath({ name: 'categories-id', params: { id: Category.id } })
                    "
                    >Link one</nuxt-link
                  >
                  <nuxt-link
                    :to="
                      localePath({ name: 'categories-id', params: { id: 10 } })
                    "
                    >Link two</nuxt-link
                  >
                  <nuxt-link
    ...
    <div class="mobile-nav" :class="{ openNavClass: toggle }">
      <div class="wrapper">
        <div class="wrapper-header">
          <nuxt-link :to="localePath('/auth/user/login')" class="header-link">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="20"
        ...
        <div class="wrapper-content">
          ...
          <ul class="list-links list-style" v-if="user == 'supplier'">
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/supplier/change-password')"
                class="list-link"
              >
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/supplier/history-order')"
                class="list-link"
              >
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/supplier/manage-products')"
                class="list-link"
              >
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/supplier/notification')"
                class="list-link"
              >
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/supplier/delivery')"
                class="list-link"
              >
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/supplier/subscription')"
                class="list-link"
              >
          ...
          <ul class="list-links list-style" v-if="user == 'profile'">
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/profile/history-order')"
                class="list-link"
              >
                <span class="text">My Orders History</span>
              </nuxt-link>
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/profile/favorite')"
                class="list-link"
              >
            ...
            <li class="list">
              <nuxt-link
                :to="localePath('/profile/notification')"
                class="list-link"
              >
                <span class="text">Notification</span>
              </nuxt-link>
...
export default {
  ...
  computed: {
    ...
    logedType() {
      return this.$auth.$storage.getUniversal("type");
    },
  },
  methods: {
    checkUser() {
    ...
    navSearch() {
      if (this.$i18n.locale == "en") {
        ...
        this.$router.push({
          path: `/${this.$i18n.locale}/categories`,
          query: {
            serchText: this.search,
          },
        });
    ...
    async signOut() {
      ...
      await this.$store.dispatch("authentication/Login/Logout");
    },
    async getCategories() {
      await this.$axios
        .$get(`home`)
