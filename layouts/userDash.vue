<template>
  <div :class="this.$i18n.locale === 'ar' ? 'rtl' : ''">
    <the-nav :toggle="toggle" @toggleNav="toggleNav"/>
    <div class="app-content" @click.passive="closeNav">
      <div class="profile">
        <the-header-page :title="`My Profile`"/>
        <div class="profile-wrapper">
          <div class="container">
            <div class="row">
              <!-- <div class="col-lg-4 col-md-3 col-12 mb-3 profile-sidebar" v-if="!mobileScreen"> -->
              <div class="col-lg-4 col-md-3 col-sm-12 mb-3 profile-sidebar">
                <the-side-bar />
              </div>
              <div class="col-lg-8 col-md-9 col-sm-12 mb-3 profile-content">
...
<script>
import TheSideBar from '~/components/profile/TheSideBar.vue';
